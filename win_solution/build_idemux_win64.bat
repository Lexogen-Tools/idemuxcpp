...
"F:\VS19\VS_IDE\MSBuild\Current\Bin\MSBuild.exe" "idemuxcpp.sln" /t:Rebuild /p:configuration=Release-cluster
...
Xcopy .\x64\Release-cluster\idemuxcpp.exe iDemux_win10_64bit\bin\ /E/H/C/I
Xcopy .\x64\Release-cluster\test_parser.exe iDemux_win10_64bit\tests\ /E/H/C/I
...
Xcopy .\vcomp140.dll iDemux_win10_64bit\bin\ /E/H/C/I
