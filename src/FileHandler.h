...
class FileHandler {
public:
FileHandler(unordered_map<string, string>&  barcode_file_map,
...
void
init_all_file_handles_single_end();


std::pair<ZipFastqWriter *, ZipFastqWriter *> *
get_file_handles(string &barcode);


string
get_sample_name(std::pair<ZipFastqWriter *, ZipFastqWriter *> *file_pair_key);
