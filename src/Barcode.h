...
inline
unordered_set<string> *
get_used_codes(bool drop_none = false)
{
...
void
load_correction_map(string  relative_exepath,
                    string  correction_maps_path = "");


void
create_one_to_one_map();


string
get_name(bool reverse = false);
