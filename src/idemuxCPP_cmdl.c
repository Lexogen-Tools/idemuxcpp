/*
  ...
  gengetopt -i idemuxCPP.ggo --file-name=idemuxCPP_cmdl --include-getopt --default-optional --func-name=idemuxCPP_cmdline_parser --arg-struct-name=idemuxCPP_args_info --file-name=idemuxCPP_cmdl --include-getopt --default-optional --func-name=idemuxCPP_cmdline_parser --arg-struct-name=idemuxCPP_args_info
...
const char *idemuxCPP_args_info_usage = "Usage: idemuxCPP [OPTIONS]...";
...
static void print_help_common(void) {
  ...
  if (strlen(idemuxCPP_args_info_purpose) > 0)
    printf("\n%s\n", idemuxCPP_args_info_purpose);

  if (strlen(idemuxCPP_args_info_usage) > 0)
