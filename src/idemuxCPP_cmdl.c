...
void init_args_info(struct idemuxCPP_args_info *args_info)
{
  ...
  args_info->i1_start_help = idemuxCPP_args_info_help[14] ;
  args_info->i1_read_help = idemuxCPP_args_info_help[15] ;
  args_info->queue_size_help = idemuxCPP_args_info_help[16] ;
  args_info->reading_threads_help = idemuxCPP_args_info_help[17] ;
  args_info->writing_threads_help = idemuxCPP_args_info_help[18] ;
  args_info->processing_threads_help = idemuxCPP_args_info_help[19] ;
